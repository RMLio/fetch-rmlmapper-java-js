...
async function download(fileName = null, version = null, toFolderPath = null) {
  let releaseMeta = await _getMetadata(version);
  return _downloadViaMetadata(releaseMeta, toFolderPath, fileName);
}
 ...
 * @returns 
 */
function _getMetadata(version = null) {
...
async function _downloadViaMetadata(metadata, fileName = null, toFolderPath = null) {
  ...
  if (asset) {
    ...
    logger.info(`Downloading the RMLMapper ${asset.tag_name}...`);
